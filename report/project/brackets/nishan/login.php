...
<div id="login-page" class="row card1">
    <div class="col s12 z-depth-5 card card1 grey darken-4 blue-text">
        <div class="login-form ">

            <div class="row no-pad-bot card-content no-pad-top ">
                <div class="input-field col s12 no-pad-bot center ">
                    ...
                    <p class="center-align text-darken-4 white-text flow-text ">FLOWN THINGS</p>
                </div>
            </div>
